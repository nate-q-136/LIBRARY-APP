...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button_UserSignIn->UseVisualStyleBackColor = true;
			...
			this->button_BackUser->UseVisualStyleBackColor = true;
			...
			this->label_SignInPass->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 13.875F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
			...
			this->label_SignInPass->Size = System::Drawing::Size(106, 42);
			...
			this->button_EnterUserSignIn->UseVisualStyleBackColor = true;
			...
			this->label_IDUserSignIn->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 13.875F, System::Drawing::FontStyle::Bold,
				System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(0)));
			...
			this->label_IDUserSignIn->Size = System::Drawing::Size(56, 42);
			...
			this->label_UserSignIn->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 13.875F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			...
			this->label_UserSignIn->Size = System::Drawing::Size(140, 42);
			...
			// panel_UserRegister
			// 
			this->panel_UserRegister->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(255)),
			...
			this->label_Pass->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 13.875F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			...
			this->label_Pass->Size = System::Drawing::Size(106, 42);
			...
			this->button_RegisterRegister->UseVisualStyleBackColor = true;
			...
			this->label_NameRegister->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 13.875F, System::Drawing::FontStyle::Bold,
				System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(0)));
			...
			this->label_NameRegister->Size = System::Drawing::Size(121, 42);
			...
			this->label_IDRegister->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(255)),
				static_cast<System::Int32>(static_cast<System::Byte>(128)), static_cast<System::Int32>(static_cast<System::Byte>(0)));
			this->label_IDRegister->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 13.875F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			...
			this->label_IDRegister->Size = System::Drawing::Size(56, 42);
			...
			this->label_RegistrationRegister->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 13.875F, System::Drawing::FontStyle::Bold,
				System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(0)));
			...
			this->label_RegistrationRegister->Size = System::Drawing::Size(229, 42);
...
Register:
	...
	for (int i = 0; i < 100; i++)
	{
		...
		// làm hàm convert string có nhiều dấu cách vào, với lại làm ko hợp lệ vs dấu cách
		// nhớ include Data_Of_Gui với class cuối
		// bắt người dùng nhập có tên đang hoàng, chỉ có dấu space là k hợp lệ
		/*else if (Data_Of_Gui[i].get_Student_Id() == "\0")
		{
			std::string tempstr = marshal_as<std::string>(textBox_Name->Text);
			/*int counter = 0;
			for (int j = 0; j < tempstr.length(); j++)
			{
				// check for whether there're special character besides the Alphabets and space or not
				if (isalpha(tempstr[j]) || isspace(tempstr[j]))
				{
					counter++;
				}
				if (counter == tempstr.length())//check if counter < tempstr, so there're some special character
				{
					MessageBox::Show("Name should only contain Alphabet letters and digits!", "Error"
						,MessageBoxButtons::OK, MessageBoxIcon::Error);
					//string temp2 = "\0";
					//Data_Of_Gui[i].set_Student_Name(temp2);
					break;
				}
			}
			MessageBox::Show("dung de trong", "Error"
				, MessageBoxButtons::OK, MessageBoxIcon::Error);
		}*/
		// về main page để update, save, load đồ
	}
...
private: System::Void button_EnterUserSignIn_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	for (int i = 0; i < 100; i++)
	{
		...
		//else if(Data_Of_Gui[i].get_Student_Id()!=tempStr)
		//{
		//	/*MessageBox::Show("Wrong ID! Please try again", "Error"
		//		, MessageBoxButtons::OK, MessageBoxIcon::Error);
		//	break;*/
		//}
		//else if (Data_Of_Gui[i].get_Student_Pass() != tempStr2)
		//{
		//	/*MessageBox::Show("Wrong Pass! Please try again", "Error"
		//		, MessageBoxButtons::OK, MessageBoxIcon::Error);
		//	break;*/
		//}
