...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// 
			this->button_ViewLibraryUserOption->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 13.875F, System::Drawing::FontStyle::Bold,
			...
			// 
			this->button_BorrowAnItemUserOption->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 13.875F, System::Drawing::FontStyle::Bold,
				System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(0)));
			...
			// 
			this->button_BackToUserOption->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 13.875F, System::Drawing::FontStyle::Bold,
				System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(0)));
			...
			this->button_BackToUserOption->UseVisualStyleBackColor = true;
			...
			this->textBox_EnterIdBook->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular,
				System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(0)));
			this->textBox_EnterIdBook->Location = System::Drawing::Point(146, 94);
			...
			this->label_NumberOfBooksToBorrow->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 13.875F, System::Drawing::FontStyle::Bold,
				System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(0)));
			this->label_NumberOfBooksToBorrow->Location = System::Drawing::Point(74, 169);
			this->label_NumberOfBooksToBorrow->Name = L"label_NumberOfBooksToBorrow";
			this->label_NumberOfBooksToBorrow->Size = System::Drawing::Size(500, 42);
			...
			this->label_EnterIdToBorrow->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 13.875F, System::Drawing::FontStyle::Bold,
				System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(0)));
			this->label_EnterIdToBorrow->Location = System::Drawing::Point(99, 23);
			this->label_EnterIdToBorrow->Name = L"label_EnterIdToBorrow";
			this->label_EnterIdToBorrow->Size = System::Drawing::Size(453, 42);
			...
			this->textBox_NumberOfBooksToBorrow->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular,
				System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(0)));
			this->textBox_NumberOfBooksToBorrow->Location = System::Drawing::Point(146, 249);
			...
			// 
			this->button_BackBorrowBorrowAnItem->Location = System::Drawing::Point(66, 346);
			...
			// 
			this->button_ConfirmBorrowAnItem->Location = System::Drawing::Point(398, 346);
			...
			this->button_ConfirmBorrowAnItem->UseVisualStyleBackColor = true;
			this->button_ConfirmBorrowAnItem->Click += gcnew System::EventHandler(this, &UserOption::button_ConfirmBorrowAnItem_Click);
			// 
			// button_ReturnAnItem
			// 
			this->button_ReturnAnItem->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 13.875F, System::Drawing::FontStyle::Bold,
				System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(0)));
			...
			this->label_EnterItemToReturn->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 13.875F, System::Drawing::FontStyle::Bold,
				System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(0)));
			this->label_EnterItemToReturn->Location = System::Drawing::Point(110, 50);
			this->label_EnterItemToReturn->Name = L"label_EnterItemToReturn";
			this->label_EnterItemToReturn->Size = System::Drawing::Size(383, 42);
			this->label_EnterItemToReturn->TabIndex = 3;
			this->label_EnterItemToReturn->Text = L"Enter Item To Return";
			...
			this->button_ReturnReturnAnItem->UseVisualStyleBackColor = true;
...
private: System::Void button_ConfirmBorrowAnItem_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	for (int i = 0; i < 100; i++)
	{
		...
		else if (Data_Of_Gui[i].get_Book_Id() == tempStrId_Book)
		{
			...
			{
				MessageBox::Show("Number of Books to Borrow Should Be Smaller Than Total Books Available", "Error", MessageBoxButtons::OK
					, MessageBoxIcon::Error);
				break;
			}
			...
			/*ofstream StuBorrow_file;
			StuBorrow_file.open("Stored_Data/StuBorrow.txt",ios::app);
			{
				StuBorrow_file << IdStudentBorrow << "," << Data_Of_Gui[i].get_Book_Id() <<Borrowed_Book<<
					"," << tempdate.day << "/" << tempdate.month
					<< "/" << tempdate.year <<","<<tempdateReturn.day
					<<"/"<<tempdateReturn.month<<"/"<<tempdateReturn.year << "\n";
			}
			StuBorrow_file.close();*/
			break;
		}
		else {
			counter++;
...
private: System::Void button_ReturnReturnAnItem_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	if (counter == 100)
	{
		MessageBox::Show("Item Are Not Being Borrowed", "Error",
			MessageBoxButtons::OK, MessageBoxIcon::Error);
	}
}
};
